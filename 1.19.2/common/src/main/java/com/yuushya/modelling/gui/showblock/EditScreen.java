...
public class EditScreen extends Screen {
    ...
    protected void init() {
        ...
        this.selectButton = this.addRenderableWidget(ButtonUtils.builder(CommonComponents.GUI_DONE, button -> this.onSelect()).bounds(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20).build());
        this.addRenderableWidget(ButtonUtils.builder(CommonComponents.GUI_CANCEL, button -> this.callback.accept(null)).bounds(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20).build());
