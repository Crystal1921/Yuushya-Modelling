...
public class SliderButton<T extends Comparable<T>> extends AbstractSliderButton implements TooltipAccessor {
    ...
    public SliderButton(Component caption,
                        ...
                        TooltipSupplier<T> tooltipSupplier,
    ...
    public Optional<List<FormattedCharSequence>> getTooltip() {
        return Optional.ofNullable(this.tooltipSupplier.apply(this.validateRange.fromSliderValue(this.value)));
    }
    ...
    public static class Builder<R extends Comparable<R>> {
        ...
        private TooltipSupplier<R> tooltipSupplier = (object)->ImmutableList.of();
        ...
        public Builder<R> tooltip(TooltipSupplier<R> tooltipSupplier){
            this.tooltipSupplier = tooltipSupplier;
            return this;
        }
