                ...
                .then(Commands.literal("reload")
                        .then(Commands.literal("blocks")
                                .executes(context -> {
                                    ...
                                    NetworkManager.sendToPlayer(player, new ReloadModelPacket(ReloadType.BLOCKS));
                        ...
                        .then(Commands.literal("items")
                                .executes(context -> {
                                    ...
                                    NetworkManager.sendToPlayer(player, new ReloadModelPacket(ReloadType.ITEMS));
                                    player.sendSystemMessage(Component.translatable("command.yuushya_modelling.reload_succeed"));
                                    return 1;
                                }))
                        .then(Commands.literal("all")
                                .executes(context -> {
                                    ...
                                    NetworkManager.sendToPlayer(player, new ReloadModelPacket(ReloadType.ALL));
                                    player.sendSystemMessage(Component.translatable("command.yuushya_modelling.reload_succeed"));
                                    return 1;
                                }))
                ));
