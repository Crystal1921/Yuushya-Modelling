...
public class GroupRegistry {
    ...
    public static final RegistryObject<CreativeModeTab> YUUSHYA_MODELLING = TABS.register("modelling", () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> YUUSHYA_PRIMITIVE = TABS.register("primitive", () -> CreativeModeTab.builder()
