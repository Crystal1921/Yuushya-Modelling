...
public class MeshData implements AutoCloseable {
    ...
    public static record DrawState(VertexFormat format, int vertexCount, int indexCount, VertexFormat.Mode mode,
